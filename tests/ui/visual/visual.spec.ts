...
test.describe('Login Page - Visual Regression', () => {
    test(
        'Login page matches the baseline visual snapshot',
        { tag: ['@auth', '@visual'] },
        async ({ page }) => {
...
test.describe('Register Page - Visual Regression', () => {
    test(
        'Register page matches the baseline visual snapshot',
        { tag: ['@auth', '@visual'] },
        async ({ page }) => {
...
test.describe('Empty Page - Visual Regression', () => {
    ...
    test(
        'No product found matches the baseline visual snapshot',
        { tag: ['@catalog', '@visual'] },
        async ({ page }) => {
    ...
    test(
        'Empty Order page matches the baseline visual snapshot',
        { tag: ['@orders', '@visual'] },
        async ({ page }) => {
    ...
    test(
        'Empty Cart page matches the baseline visual snapshot',
        { tag: ['@orders', '@visual'] },
        async ({ page }) => {
