...
export const SHIPPING_CASES: readonly ShippingCase[] = [
    { label: 'a cent under the threshold', price: 99.99, expectedTax: 10, expectedShipping: 10, expectedTotal: 119.99 },
    { label: 'exactly at the threshold', price: 100, expectedTax: 10, expectedShipping: 10, expectedTotal: 120 },
    { label: 'a cent over the threshold', price: 100.01, expectedTax: 10, expectedShipping: 0, expectedTotal: 110.01 },
    { label: 'well over the threshold', price: 199.99, expectedTax: 20, expectedShipping: 0, expectedTotal: 219.99 },
];
